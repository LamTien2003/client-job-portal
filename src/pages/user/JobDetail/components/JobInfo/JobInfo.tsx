                ...
                <div className=" flex justify-end xl:ml-5 lg:flex-col mb:ml-0">
                    <div className=" mr-6 xl:mr-3 lg:mb-2">
                        ...
                        <div className=" flex items-center relative">
                            <img className=" mr-1.5 top-[5px] absolute" src="https://demo-egenslab.b-cdn.net/html/jobes/preview/assets/images/icon/category-2.svg" />
                            <p className=" text-content-text text-base font-normal ml-5"><span className=" text-content-title font-medium mr-1.5">Ngành:</span>{job.type.categoryName}</p>
                        </div>
                    </div>
                    <div>
                        <div className=" mb-2 flex items-center relative">
                            <img className=" mr-1.5 top-[5px] absolute" src="https://demo-egenslab.b-cdn.net/html/jobes/preview/assets/images/icon/company-2.svg" />
                            <p className=" text-content-text text-base font-normal ml-5"><span className=" text-content-title font-medium mr-1.5">Job Type:</span>fulltime</p>
                        </div>
                        <div className=" flex items-center relative">
                            <img className=" mr-1.5 top-[5px] absolute" src="https://demo-egenslab.b-cdn.net/html/jobes/preview/assets/images/icon/salary-2.svg" />
                            <p className=" text-content-text text-base font-normal ml-5"><span className=" text-content-title font-medium mr-1.5">Lương:</span>{job.salary.toLocaleString('it')}vnđ / tháng</p>
                        </div>
                    </div>
                </div>
            </div>
