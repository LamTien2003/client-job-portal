        ...
        <div className=" w-[244px] mb-4 mr-4 ml-4">
            ...
            <div className="relative block mb-3">
                ...
                <Select
                    ...
                    className=" h-[41.6px] text-content-text block bg-white w-full border border-teal-100 hover:border-teal-400 rounded-md py-2.5 pl-9 pr-3 focus:outline-none focus:border-teal-200 focus:shadow-outline cursor-pointer"
                >
