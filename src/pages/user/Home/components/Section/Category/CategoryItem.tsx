...
const CategoryItem = ({ category, images }: { category: Category; images: string }) => {
    return (
        <Link
            ...
            className="flex justify-between items-center border-[2px] border-primary-blur rounded-md p-3 hover:border-primary-100  duration-300 gap-2 tb:justify-center tb:gap-5 mb:justify-center mb:gap-8"
        >
