                            ...
                            <div className=" flex flex-col relative">
                                <div className=" mb-7.5 flex items-center relative lg:flex-col lg:items-start">
                                    <div className=" flex items-center lg:flex-col lg:items-start lg:mb-8">
                                        <img className=" w-13 h-13 rounded-full mr-2.5 lg:mb-3" src={company.photo} />
                                        <div className=" flex flex-col">
                                            <h2 className=" text-content-title text-lg font-semibold mb-0.5 duration-300 cursor-pointer hover:text-primary-100">{job.title}</h2>
                                            <p className=" text-sm font-medium duration-300 cursor-pointer hover:text-primary-100">{company.companyName}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className=" flex tb:flex-col">
                                        <div className=" flex flex-col tb:mb-1 ">
                                            <div className=" relative pl-3 mb-1 before:w-2 before:h-2 before:rounded-full before:bg-primary-100 before:top-1.75 before:left-0 before:absolute">
                                                <p className=" text-cb font-medium">Location:<span className=" font-semibold ml-1.5">{company.location}</span></p>
                                            </div>
                                            <div className=" relative pl-3 before:w-2 before:h-2 before:rounded-full before:bg-primary-100 before:top-1.75 before:left-0 before:absolute">
                                                <p className=" text-cb font-medium">Salary:<span className=" font-semibold ml-1.5">{job.salary.toLocaleString('it')}vnđ /</span> tháng</p>
                                            </div>
                                        </div>
