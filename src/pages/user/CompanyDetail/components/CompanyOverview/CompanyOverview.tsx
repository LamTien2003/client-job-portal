    ...
    return (
        <div className=" w-1/3 pl-3 lg:w-full">
                ...
                <div>
                    <div className=" mb-2.5 flex relative before:w-2 before:h-2 before:rounded-full before:bg-primary-blur before:left-0 before:top-1.75 before:absolute">
                        <p className=" text-cb pl-3.5 font-medium">
                            <span className=" text-content-title font-semibold mr-1.5">Company Name:</span>
                            {company.companyName}
                        </p>
                    </div>
                    <div className=" mb-2.5 flex relative before:w-2 before:h-2 before:rounded-full before:bg-primary-blur before:left-0 before:top-1.75 before:absolute">
                        <p className=" text-cb pl-3.5 font-medium">
                            <span className=" text-content-title font-semibold mr-1.5">Category:</span>
                            {company.type}
                        </p>
                    </div>
                    <div className=" mb-2.5 flex relative before:w-2 before:h-2 before:rounded-full before:bg-primary-blur before:left-0 before:top-1.75 before:absolute">
                    ...
                    <div className=" mb-2.5 flex relative before:w-2 before:h-2 before:rounded-full before:bg-primary-blur before:left-0 before:top-1.75 before:absolute">
                        <p className=" text-cb pl-3.5 font-medium">
                            <span className=" text-content-title font-semibold mr-1.5">Member Since:</span>
                            {myDateString}
                        </p>
                    </div>
                    <div className=" mb-2.5 flex relative before:w-2 before:h-2 before:rounded-full before:bg-primary-blur before:left-0 before:top-1.75 before:absolute">
                        <p className=" text-cb pl-3.5 font-medium">
                            <span className=" text-content-title font-semibold mr-1.5">Company size:</span>{' '}
                            {company.companySize.from + ' - ' + company.companySize.to} (người)
                        </p>
                    </div>
                    <div className=" mb-2.5 flex relative before:w-2 before:h-2 before:rounded-full before:bg-primary-blur before:left-0 before:top-1.75 before:absolute">
                        <p className=" text-cb pl-3.5 font-medium">
                            <span className=" text-content-title font-semibold mr-1.5">Completed Job:</span>
                        </p>
                    </div>
                    <div className=" mb-2.5 flex relative before:w-2 before:h-2 before:rounded-full before:bg-primary-blur before:left-0 before:top-1.75 before:absolute">
                        <p className=" text-cb pl-3.5 font-medium">
                            <span className=" text-content-title font-semibold mr-1.5">Last Job Posted:</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <a
                ...
                className=" flex justify-center text-primary-100 font-medium border border-content-border rounded-md pt-3 pb-3 duration-300 hover:bg-primary-100 hover:text-white lg:mb-12"
            >
                Go Our Site Map
            </a>
        </div>
