...
// import JobColumnItem from "./JobColumnItem/JobColumnItem";
                                ...
                                <div className=' flex items-center tb:flex-col tb:items-start '>
                                    <div className=' flex tb:mb-8'>
                                        ...
                                        <div className=' flex flex-col'>
                                            <h3 className=' text-content-title text-lg font-semibold cursor-pointer duration-300 hover:text-primary-100 lg:text-base '>{job.title}</h3>
                                            <p className=' text-content-text text-sm cursor-pointer duration-300 hover:text-primary-100 lg:text-sm'>{job.postedBy.location}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className=' flex flex-col'>
                                        <div className=' flex items-center before:w-2 before:h-2 before:bg-primary-100 before:rounded-full before:mr-1.5 -mt-3'>
                                            <p className=' text-content-text text-cb font-medium lg:text-sm '>Lương: <span className=' text-content-title font-medium'>{job.salary.toLocaleString('it')}đ / </span> <span className=' text-sm'>tháng</span></p>
                                        </div>
                                        <div className=' flex items-center before:w-2 before:h-2 before:bg-primary-100 before:rounded-full before:mr-1.5 mt-1'>
                                            <p className=' text-content-text text-cb font-medium lg:text-sm'>Hạn chót: <span className=' text-content-title font-medium'>05 April, 2023</span></p>
                                        </div>
                                    </div>
                                </div>
                                <div className=' group '>
