...
function CompanyGutter() {
    
    const companyApi = 'https://job-portal-server-e9q1.onrender.com/company'
    const [companies, setCompanies] = useState<any[]>([])

    useEffect(() => {
        axiosClient.get(companyApi)
                            ...
                            <div className=" w-full relative">
                                <div className=" border-b border-content-border pb-4 flex">
                                    <div className=" flex flex-col ">
                                        <h3 className=" text-content-title text-base font-semibold duration-300 cursor-pointer hover:text-primary-100 mb-1 mb:text-cb">{company.companyName}</h3>
                                        <div className=" flex items-center">
                                            <img className=" mr-2" src="https://demo-egenslab.b-cdn.net/html/jobes/preview/assets/images/icon/location.svg" />
                                            <p className=" text-content-text text-sm font-medium mb:text-xs">{company.location}</p>
                                        </div>
                                    </div>
                                ...
                                <div className=" pt-4 flex relative mb:flex-col">
                                    <p className=" text-content-text text-base font-medium">Vacancies: <span className=" text-primary-100 font-bold">21</span></p>
                                    
                                    <div className=' group right-0 absolute mb:static mb:mt-3 mb:ml-2'>
                                        <Link to={'/company-detail/' + company.id} className=' text-primary-100 flex items-center relative group-hover:cursor-pointer '>
