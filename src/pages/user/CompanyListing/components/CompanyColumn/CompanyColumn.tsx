                    ...
                    <div key={company.id} className=' w-6/12 pr-3 pl-3 mb-6 relative tb:w-full '>
                        <div className=" border border-primary-blur rounded pl-4 duration-300 hover:border-primary-100">
                            <div className=" bg-primary-40 pt-5 pb-5 mb-5 relative">
                                <img className=" rounded-full left-2.25 top-6 absolute z-10" src={company.photo} />
                                <h3 className=" text-content-title text-base font-semibold duration-300 mb-1 ml-17.5 cursor-pointer hover:text-primary-100">{company.companyName}</h3>
                            ...
                            <div className=" mr-4 mb-6 flex relative">
                                <p className=" text-content-text text-base font-medium">Vacancies: <span className=" text-primary-100 font-bold">22</span></p>
