        ...
        <div className=" mt-[90px] px-5 relative">
            ...
            <div className=" flex items-center justify-between lg:flex-col tb:flex-col mb:flex-col">
                <div className=" flex items-center justify-start border-b border-gray-800 pb-10 xl:flex-col xl:pb-[50px] lg:mb-4 lg:border-none lg:pb-0 lg:w-full lg:justify-center tb:border-none tb:pb-[30px] mb:border-none mb:pb-[25px] ">
                    ...
                    <p className=" text-[#00A7AC] text-lg font-medium underline pl-[25px] duration-300 cursor-pointer hover:text-[#b3b3b3] xl:text-lg mb:text-base">+84 931 496 613</p>
                </div>
                <div className=" flex items-center justify-end border-b border-gray-800 pb-10 pr-3 gap-[40px] xl:flex-col xl:gap-[25px] lg:w-full lg:justify-center lg:mb-4 tb:gap-[20px] mb:flex-col mb:gap-[10px]">
                    <p className="text-[#b3b3b3] text-sm font-medium tracking-wide duration-300 hover:text-primary-100 cursor-pointer xl:text-sm tb:text-sm">Chính sách bảo mật</p>
                    <p className="text-[#b3b3b3] text-sm font-medium tracking-wide duration-300 hover:text-primary-100 cursor-pointer xl:text-sm tb:text-sm">Điều khoản dịch vụ</p>
                    <p className="text-[#b3b3b3] text-sm font-medium tracking-wide duration-300 hover:text-primary-100 cursor-pointer xl:text-sm tb:text-sm">Sơ đồ Website</p>
                </div>
            </div>
            ...
            <div className=" flex items-center justify-between py-5 pt-[25px] lg:flex-col tb:flex-col mb:flex-col ">
                <div className=" flex items-center justify-start xl:text-sm">
                    <p className=" text-sm ml-3">Thiết kế và thực hiện bởi
                        <span className=" text-primary-100 duration-300 cursor-pointer hover:text-[#b3b3b3]"> JOBHUB </span>
                        -- version 
                        <span className=" text-primary-100 duration-300 cursor-pointer hover:text-[#b3b3b3]"> 1.0.0 </span>
                    </p>
                </div>
