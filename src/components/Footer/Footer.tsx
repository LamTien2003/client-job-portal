...
const Footer = () => {
    ...
    return (
        <footer className="bg-footer-bg text-white min-h-[539px]">
            {/* FOOTER trên */}
            <div className="grid grid-cols-4 pt-[93px] max-w-7xl m-auto mt-12 ">
                <div>
                    <p className="title-ft">
                        About Company
                    </p>
                    <ul className="text-ft">
                        <li className="flex items-center group">
                            <span>Contact Us</span>
                            <FontAwesomeIcon className="ml-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300" icon={faArrowUpRightDots} />
                        </li>
                ...
                <div className="">
                    ...
                    <div className="w-[189px] h-[75px] rounded-md mt-[20px] border-solid border  border-footer-color-boder">
                        <img className="m-auto mt-[12px]" src="https://demo-egenslab.b-cdn.net/html/jobes/preview/assets/images/icon/apple-app.svg" alt="" />
                    </div>
                    <div className="w-[189px] h-[75px] rounded-md mt-[20px] border-solid border border-footer-color-boder">
                        <img className="m-auto mt-[12px]" src="https://demo-egenslab.b-cdn.net/html/jobes/preview/assets/images/icon/google-play.svg" alt="" />
                    </div>
                </div>
            </div>

            {/* FOOTER dưới */}
            <div className="max-w-7xl m-auto mt-[70px] h-[100px] ">
                <div className="grid grid-cols-3 pt-0">
                    <div className="flex items-center space-x-4">
                        ...
                        <a href="#" className="text-footer-color-hover text-[1.25rem] ml-[20px] underline decoration-solid hover:text-footer-text">+099-035 7398 3465</a>
                    </div>
